...
{
    /// <inheritdoc />
    public partial class AddDescriptionAndShortNameFields : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                columns: new[] { "short_name", "description" },
                values: new object[]
                {
...
Объяснение: 70 лет больше или равно 65, это пенсионер"
        ...
        {
            migrationBuilder.DropColumn(name: "description", table: "exercises");

            migrationBuilder.DropColumn(name: "short_name", table: "exercises");
        }
    }
}
